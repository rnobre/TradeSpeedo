...
<div class="row">
    ...
    <div class="col-md-2"><asp:Image runat="server"/></div>
    <div class="col-md-2"><asp:upload runat="server"></asp:upload></div>
    <div class="col-md-2"><asp:dropdown runat="server"></asp:dropdown> </div>
    <div class="col-md-2"><asp:dropdown runat="server"></asp:dropdown></div>
</div>
    </div>
    </form>
